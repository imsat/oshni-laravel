...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ route('admin.dashboard') }}" class="brand-link">
            ...
            <span class="brand-text font-weight-light">Coding Test</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.sale-returns.index') }}" class="nav-link {{ request()->routeIs('admin.sale-returns.*') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-th"></i>
                            <p>Sale Returns</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.reports.stocks.index') }}" class="nav-link {{ request()->routeIs('admin.reports.stocks.*') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-th"></i>
                            <p>Stock Report</p>
                        </a>
                    </li>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2014-{{ date('Y') }} <a href="https://oshnisoftware.com" target="_blank">Oshni Software</a>.</strong>
        All rights reserved.
