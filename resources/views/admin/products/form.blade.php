                ...
                <div class="card-body">
                    <form class="form" action="@yield('action-url')" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="purchase_price @error('purchase_price') text-danger @enderror">Purchase
                                        Price</label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group @error('purchase_price') text-danger @enderror">
                                    <label for="bannerImage">Image</label>
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file"
                                                   class="custom-file-input @error('purchase_price') is-invalid @enderror"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="sale_price @error('sale_price') text-danger @enderror">Sale
                                        Price</label>
                                    <input id="sale_price"
